...
function testRunner() {
    ...
    //console.log("Passed 'returns string message for a decimal': " + getCarTelemetry_GivenNonNumericDecimal_ReturnStringMessage());
}
...
function getCarTelemetry_GivenNonNumericDecimal_ReturnStringMessage()
{
    // Arrange
    const car =
        {
